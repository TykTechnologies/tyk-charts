...
`tyk-single-dc` provides the default deployment of Tyk Self Managed for single data center. It will deploy all required Tyk components with the settings provided in the values.yaml file.
